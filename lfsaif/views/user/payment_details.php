        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php  echo $totalSubmit = $this->Common_model->getTotalSumbmission($user_id)->counts; ?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Amount (1/$1)</span>
                <span class="info-box-number">$<?php echo $totalSubmit * 1?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
