							...
							<form method="POST" action="" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-md-12">
										...
										<div class="col-sm-12">
											<input type="text" id="form-field-1" name="title" class="form-control required" placeholder="Title" />
										</div>
									</div>
									<div class="col-md-12">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> URL </label>
										<div class="col-sm-12">
											<input type="text" id="form-field-1" name="url" class="form-control required" placeholder="Url" />
										</div>
									</div>
									<div class="col-md-12">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Discription </label>
										<div class="col-sm-12">
											<textarea type="text" id="form-field-1" name="description" class="form-control required" placeholder="Details"></textarea>
										</div>
									</div>
									<div class="col-md-12">
