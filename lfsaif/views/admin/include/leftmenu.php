        ...
        <?php else : ?>
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <!--                    <li class="nav-item has-treeview">
                                            <a href="#" class="<?php //echo ($mymenu == "new-payment" or $mymenu == "payment-details" ) ? "active" : "";     ?> nav-link">
                                                <p>
                                                    Payment
                                                    <i class="fas fa-angle-left right"></i>
                                                </p>
                                            ...
                                            <ul class="nav nav-treeview">
                                                <li class="nav-item">
                                                    <a href="<?php //echo site_url('new-payment');     ?>" class="<?php //echo ($mymenu == "new-payment") ? "active" : "";     ?> nav-link">
                                                        <p>New Payment</p>
                                                    </a>
                                                </li>
                                                                            <li class="nav-item">
                                                                                <a href="<?php //echo site_url('payment-details');                    ?>" class="<?php //echo ($mymenu=="payment-details")?"active":"";                    ?> nav-link">
                                                                                    <p>Payment Status</p>
                                                                                </a>
                                                                            </li>
                                            </ul>
