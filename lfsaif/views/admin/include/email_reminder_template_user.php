                                    ...
                                    <tr>
                                        <td>
                                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="200" style="border-collapse: collapse;">
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <a href="https://www.lightsflare.com/">
                                                            <img width="120px" src="https://www.lightsflare.com/assets/frontend/images/logo_dark_red.png" alt="Company Logo" style="display: block;"/>
                                                        </a>
                                                    </td>
                                                </tr>
                                                <!-- company slogan -->
                                                        ...
                                                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="72%" style="border-collapse: collapse;">
                                                            <tr>
                                                                <td width="100%" align="left" style="font-size: 15px; line-height: 22px; font-family:helvetica, Arial, sans-serif; color:#666666;">
                                                                    ...
                                                                    <p>Dear <b><?php echo $u_name; ?></b>
                                                                        <p>Thank you so much for registering on the 'Lightsflare International Photography Award 2020' website. If your entry was not completed before the official registration deadline, we are giving you a few extra days to finalize your entry!</p>
                                                                        <p>Click here to complete your entry before midnight on Friday, November 20th. Last chance to participate in the competition.</p>
                                                                        <p>This will be the final deadline, and there will be no exceptions or further entries accepted beyond November 20th, 2020.</p>
                                                                        <p>Enter the competition now before it's too late <br><a target="_blank" href="https://www.lightsflare.com/user-signin" style="font-size: 28px; line-height: 34px; font-family:helvetica, Arial, sans-serif; color:#343434;" >Click Here</a> </p>
                                                                        <p>If you have any questions let us know, we will be happy to help you.</p>
                                                                        
                                                                        <p>Regards,</p>

                                                                     <address>
                                                                            Razia Sultana<br>
                                                                            Sr. Executive of Lightsflare<br>
                                                                                info@lightsflare.com<br>
                                                                                    Live Chat WhatsApp : +88 01313951100
                                                                                    </address>
                                                                                                                        ...
                                                                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="540" style="border-collapse: collapse;">
                                                                                                                            <tr>
                                                                                                                                <td align="center" style="color: #999999; font-size: 14px; line-height: 18px; font-weight: normal; font-family: helvetica, Arial, sans-serif;">
                                                                                                                                    Copyright © 2020  <a href="https://www.lightsflare.com/" style="color: #cdcdcd; font-size: 14px; line-height: 18px; font-weight: normal; font-family: helvetica, Arial, sans-serif; text-decoration:none;">LightsFlare</a>. All Rights Reserved 
                                                                                                                                </td>
                                                                                                                            </tr>
                                                                                                                        </table>
                                                                                                                        <!-- Space -->
